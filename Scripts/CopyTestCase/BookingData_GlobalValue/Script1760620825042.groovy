...
WebUI.setText(findTestObject('Object Repository/Page_Book Dummy Hotel - Dummy Travels/input_First Name_firstName'), GlobalVariable.CustomerName)

WebUI.setText(findTestObject('Object Repository/Page_Book Dummy Hotel - Dummy Travels/input_Last Name_lastName'), GlobalVariable.CustomerLastName)
