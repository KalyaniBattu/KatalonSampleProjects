...
WebUI.setText(findTestObject('Object Repository/Page_Book Dummy Hotel - Dummy Travels/input_First Name_firstName'), CusName)

WebUI.setText(findTestObject('Object Repository/Page_Book Dummy Hotel - Dummy Travels/input_Last Name_lastName'), CusLastname)
