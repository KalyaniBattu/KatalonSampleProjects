...
WebUI.doubleClick(findTestObject('Object Repository/Page_JPetStore Demo/td'))

WebUI.rightClick(findTestObject('Object Repository/Page_JPetStore Demo/td'))
...
WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/img_2'))
